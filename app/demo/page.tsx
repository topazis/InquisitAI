...
export default function DemoPage() {
  ...
  const urlPreset =
    urlPresetRaw === "simulation" ||
    urlPresetRaw === "voicemail" ||
    urlPresetRaw === "brain10" ||
    urlPresetRaw === "custom"
      ? (urlPresetRaw as PresetId)
      : null;

  const initialPreset: PresetId =
    urlPreset && urlPreset !== "custom" ? urlPreset : "simulation";
